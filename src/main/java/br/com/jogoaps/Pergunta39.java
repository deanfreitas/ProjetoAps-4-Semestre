...
public class Pergunta39 extends JFrame implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -13921427620289437L;
	...
	public Pergunta39(double pontuacao, String nomeJogador) {
		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("39º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("v1.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"39 - Quantos caminhões de coleta de lixo tem em São Paulo ?");
		...
		respostaA = new JButton("A)  100 Caminhões");
		...
		respostaB = new JButton("B)  200 Caminhões");
		...
		respostaC = new JButton("C)  500 Caminhões");// VERDADE
		...
		respostaD = new JButton("D)  750 Caminhões");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			...
			Pergunta40 obj41 = new Pergunta40(pontuacao, nomeJogador);
