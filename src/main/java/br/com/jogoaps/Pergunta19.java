...
public class Pergunta19 extends JFrame implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6612175754284154537L;
	...
	public Pergunta19(double pontuacao, String nomeJogador) {
		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("19º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("u.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"<html>19 - Quantas toneladas de lixo são<br> retiradas do rio Tietê por ano ?</html>");
		...
		respostaA = new JButton("A)  10,1 mil toneladas  ");
		...
		respostaB = new JButton("B)  1,7 mil toneladas   ");
		...
		respostaC = new JButton("C)  7,0 mil toneladas    ");
		...
		respostaD = new JButton("D)  3,7 mil toneladas   ");// verdade
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			...
			Pergunta20 obj21 = new Pergunta20(pontuacao, nomeJogador);
