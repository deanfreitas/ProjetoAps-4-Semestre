...
public class Pergunta21 extends JFrame implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2366549685332336436L;
	...
	public Pergunta21(double pontuacao, String nomeJogador) {
		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("21º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("a1.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"<html>21 - De acordo com a coleta seletiva de resíduos,<br>"
				+ " que tipo de material deve ser descartado no recipiente azul ? </html>");
		...
		respostaD = new JButton("D)  Papel   ");// verdade
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			...
			Pergunta22 obj23 = new Pergunta22(pontuacao, nomeJogador);
