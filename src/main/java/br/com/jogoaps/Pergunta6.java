...
public class Pergunta6 extends JFrame implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5593405517035202743L;
	...
	public Pergunta6(double pontuacao, String nomeJogador) {
		...
		setTitle("6º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("g.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel("6 - O que são rejeitos radioativos ?");
		...
		respostaA = new JButton(
				"A)  São resíduos produzidos pela decomposição orgânica ");
		...
		respostaB = new JButton("B)  É o resultado da contaminação do solo ");
		...
		respostaC = new JButton(
				"C) qualquer matéria de atividade humana que tenha elementos radioativos ");// verdade
		...
		respostaD = new JButton("D)  Resíduos produzidos nas residências ");
