...
public class Pergunta35 extends JFrame implements ActionListener {
	...
	public Pergunta35(double pontuacao, String nomeJogador) {
		...
		setTitle("35º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon("./src/m1.jpg");
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"<html>35 - Para diminuir o acúmulo de lixo e, assim, reduzir a exploração de recursos<br>"
				+ "naturais, adotou-se três erres: Redução, Reutilização e Reciclagem, um Ex. ?</html>");
		...
		respostaB = new JButton(
				"B)  Latas de alumínio como material para fabricação de lingotes");// VERDADE
