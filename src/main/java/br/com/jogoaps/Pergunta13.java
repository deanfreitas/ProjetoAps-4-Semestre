...
public class Pergunta13 extends JFrame implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8692140594187171189L;
	...
	public Pergunta13(double pontuacao, String nomeJogador) {
		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("13º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("o.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"13 - Qual a maior Composição do lixo brasileiro ?");
		...
		respostaA = new JButton("A)  Papel e papelão ");
		...
		respostaB = new JButton("B)   Plástico  ");
		respostaB.setSize(200, 50);
		respostaB.setLocation(70, 220);
		...
		respostaC = new JButton(
				"<html>C)  Metais como, por exemplo,<br> ferro, alumínio, aço, etc. </html> ");
		...
		respostaD = new JButton("D)  Lixo orgânico  ");// VERDADE
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			...
			Pergunta14 obj15 = new Pergunta14(pontuacao, nomeJogador);
