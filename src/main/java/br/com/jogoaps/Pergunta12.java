...
public class Pergunta12 extends JFrame implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3457185263106593758L;
	...
	public Pergunta12(double pontuacao, String nomeJogador) {
		...
		setTitle("12º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("n.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"<html>12 - Quais os grupos de resíduos encontrados nos<br> Estabelecimentos de Assistência à Saude (EAS) ?</html>");
		...
		respostaA = new JButton(
				"A)  Biológicos, comuns, chorume, radioativos, químicos ");
		...
		respostaB = new JButton("B)  Luminosos, químicos radioativos ");
		...
		respostaC = new JButton(
				"C)  Radioativos, químicos, comuns, biológicos  ");// verdade
		...
		respostaD = new JButton("D)  Comuns, reciclavéis, biológicos  ");
