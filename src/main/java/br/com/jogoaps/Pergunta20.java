...
public class Pergunta20 extends JFrame implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7557325425365684623L;
	...
	public Pergunta20(double pontuacao, String nomeJogador) {
		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("20º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("x.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"<html>20 - De acordo com a coleta seletiva de resíduos,<br>"
				+ " que tipo de material deve ser descartados no recipiente vermelho ?</html ");
		...
		respostaC = new JButton("C)  Plástico    ");// verdade
		respostaC.setSize(200, 50);
		respostaC.setLocation(65, 280);
		...
		respostaD = new JButton("D)  Lixo hospitalar   ");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			...
			Pergunta21 obj22 = new Pergunta21(pontuacao, nomeJogador);
