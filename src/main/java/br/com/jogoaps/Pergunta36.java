...
public class Pergunta36 extends JFrame implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8858443848773133263L;
	...
	public Pergunta36(double pontuacao, String nomeJogador) {
		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("36º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("k1.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"<html>36 - De acordo com a Organização das Nações Unidas, cada pessoa necessita de cerca<br>"
				+ "de 110 litros de água por dia, para atender as necessidades, mas no brasil e usado ?</html> ");
		...
		respostaA = new JButton("A)  200 Litros");
		...
		respostaB = new JButton("B)  220 Litros");// VERDADE
		...
		respostaC = new JButton("C)  80 Litros");
		...
		respostaD = new JButton("D)  100 Litros");
		respostaD.setSize(200, 50);
		respostaD.setLocation(45, 340);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			...
			Pergunta37 obj38 = new Pergunta37(pontuacao, nomeJogador);
