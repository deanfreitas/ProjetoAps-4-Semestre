...
public class Pergunta22 extends JFrame implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5805769849300061443L;
	...
	public Pergunta22(double pontuacao, String nomeJogador) {
		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("22º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("v.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"<html>22 - De acordo com a coleta seletiva de resíduos, que tipo de material<br>"
				+ " deve ser descartado no recipiente verde ? </html>");
		...
		respostaB = new JButton("B)  Vidro   ");// verdade
		...
		respostaC = new JButton("C)  Plástico    ");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			...
			Pergunta23 obj24 = new Pergunta23(pontuacao, nomeJogador);
