...
public class Pergunta8 extends JFrame implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4399455061001064463L;
	...
	public Pergunta8(double pontuacao, String nomeJogador) {
		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("8º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("i.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel("8 - O que é desequilíbrio ambiental ?");
		...
		respostaA = new JButton(
				"A)  Interação com o meio, tornando-o produtivo ");
		...
		respostaB = new JButton(
				"B)  Emissão desenfreada de gases, crescimento populacional ");// verdade
		respostaB.setSize(700, 50);
		respostaB.setLocation(65, 220);
		...
		respostaC = new JButton("C)  É benéfico para atmosfera terrestre ");
		...
		respostaD = new JButton("D)  Consequência de terremotos ");
		respostaD.setSize(500, 50);
		respostaD.setLocation(22, 340);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			...
			Pergunta9 obj10 = new Pergunta9(pontuacao, nomeJogador);
