...
public class Pergunta14 extends JFrame implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7682665307798010906L;
	...
	public Pergunta14(double pontuacao, String nomeJogador) {
		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("14º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("p.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"14 - Qual o principal Destino do lixo brasileiro ?");
		...
		respostaA = new JButton("A)  aterros sanitários ");// verdade
		...
		respostaB = new JButton("B)  aterros controlados  ");
		...
		respostaC = new JButton("C)  lixões   ");
		...
		respostaD = new JButton("D)  compostagem e reciclagem  ");
		respostaD.setSize(500, 50);
		respostaD.setLocation(15, 340);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			pontuacao += 2.5;
			Pergunta15 obj16 = new Pergunta15(pontuacao, nomeJogador);
