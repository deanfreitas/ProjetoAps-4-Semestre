...
public class Pergunta24 extends JFrame implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5809291833300978965L;
	...
	public Pergunta24(double pontuacao, String nomeJogador) {

		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("24º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("b1.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel(
				"<html>24 - Uma garrafa de vidro  descartada de modo indevido na natureza<br>"
				+ "demora até quanto tempo para se decompor ?  </html>");
		...
		respostaB = new JButton("B)  50 anos   ");
		...
		respostaC = new JButton("C)  5000 anos    ");
		respostaC.setSize(200, 50);
		respostaC.setLocation(70, 280);
		...
		respostaD = new JButton("D)  400 anos   ");// verdade
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			...
			Pergunta25 obj26 = new Pergunta25(pontuacao, nomeJogador);
