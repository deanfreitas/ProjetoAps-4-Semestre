...
public class Pergunta4 extends JFrame implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4706272589864039831L;
	...
	public Pergunta4(double pontuacao, String nomeJogador) {
		this.pontuacao = pontuacao;
		this.nomeJogador = nomeJogador;
		setTitle("4º PERGUNTA");
		setSize(900, 600);
		setResizable(false);
		setLocation(50, 50);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("e.jpg"));
		imagem = new JLabel(icon);
		imagem.setLocation(0, 0);
		imagem.setSize(900, 600);

		pergunta = new JLabel("4 - Qual a importância da reciclagem ?");
		...
		respostaA = new JButton("A)  Não contribuir para natureza ");
		respostaA.setSize(400, 50);
		respostaA.setLocation(65, 160);
		...
		respostaB = new JButton("B)  Ter um planeta saudável "); // verdade
		...
		respostaC = new JButton("C)  Derramar mercúrio na água ");
		...
		respostaD = new JButton("D)  Economizar sacos de lixo  ");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == respostaA) {
			...
			Pergunta5 obj6 = new Pergunta5(pontuacao, nomeJogador);
